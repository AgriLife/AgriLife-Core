...
$agrilife_single_column_template = new \AgriLife\Core\PageTemplate();
$agrilife_single_column_template->with_path( AG_CORE_TEMPLATE_PATH )->with_file( 'singlecolumn' )->with_name( 'Single Column' );
$agrilife_single_column_template->register();
